...
def data_page():
    ...
    st.sidebar.title("Data Understnading")
    st.sidebar.write("This help you to understand the data that you will use")
    ...
    with col2:
        ...
        dataset_path = r"data/full_data.csv"
